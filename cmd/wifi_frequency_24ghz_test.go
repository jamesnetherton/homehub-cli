...
func TestWiFiFrquency24GhzCommand(t *testing.T) {
	...
	hub.EXPECT().WiFiFrequency24Ghz().Return(frequency, nil)

	AssertCommandOutput(t, NewWiFiFrquency24GhzCommand(NewLoginCommand()))
}
